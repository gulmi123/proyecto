...
public class UsuarioService {
	...
	public Usuario getUsuarioByLogin(String login,String password,String tipoUusario,String estado) {
		return getUsuarioDAO().getUsuarioByLogin(login,password,tipoUusario,estado);
	}
